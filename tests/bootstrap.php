<?php
/**
 * Woocommerce_Mailchimp_Auto_Signup Test Bootstrapper.
 *
 * @since   0.0.1
 ...
 * @since 0.0.1
 */
function _manually_load_woocommerce_mailchimp_auto_signup_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/woocommerce-mailchimp-auto-signup.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_woocommerce_mailchimp_auto_signup_plugin' );
